  ...
  template: `
    <nav class="sidebar-nav">
      <mat-nav-list>
        ...
        <a mat-list-item routerLink="/badges" routerLinkActive="active">
          <mat-icon matListItemIcon>emoji_events</mat-icon>
          <span matListItemTitle>Tous les badges</span>
        </a>
        <a mat-list-item routerLink="/my-badges" routerLinkActive="active">
          <mat-icon matListItemIcon>military_tech</mat-icon>
          <span matListItemTitle>Mes badges</span>
        </a>
